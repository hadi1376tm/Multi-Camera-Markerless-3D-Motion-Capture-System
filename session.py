...
class Session:
    def __init__(self):
        ...
        self.sessionID = '' #The sessionID
        self.sessionPath = '' # "synced Vids"
    ...
    def start_session(self,paramDict,rotDict):
        ...
        Calls the create_theSessions_paths and create_session_dictionary function
        """

        if self.basePath.stem == self.dataFolderName:
        ...
        self.pathList = self.create_theSessions_paths()
    ...
    def create_theSessions_paths(self):
        """ 
    ...
    def initialize(self,stage):
        ...
        if self.session_yaml_path.is_file():
            ...
            for vid in a_sync_vid_path:
                ...
                temp_cap.release()
            frame_check = len(list(set(list(frames_per_cam.values())))) == 1
